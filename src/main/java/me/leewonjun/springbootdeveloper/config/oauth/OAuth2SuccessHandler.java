...
import me.leewonjun.springbootdeveloper.util.CookieUtil;
...
public class OAuth2SuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    private void saveRefreshToken(Long userId, String newRefreshToken) {
        RefreshToken refreshToken = refreshTokenRepository.findByUserId(userId).map(entiry -> entiry.update(newRefreshToken)).orElse(new RefreshToken(userId, newRefreshToken));
